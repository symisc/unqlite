 ...
 */
/* $SymiscID: unqlite_kv_intro.c v1.0 FreeBSD 2026-05-14 10:17 stable <chm@symisc.net> $ */
/* 
...
int main(int argc,char *argv[])
{
	...
	rc = unqlite_kv_store_fmt(pDb,"date",-1,"dummy date: %d:%d:%d",2026,06,07); /* Dummy date */
	if( rc != UNQLITE_OK ){
		/* Insertion fail, extract database error log and exit */
		Fatal(pDb,0);
	}
